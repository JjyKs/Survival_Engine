...
public class LightMap {
    ...
    float[][] lightPoints = new float[32][58];
    ...
    public void tick() {
        for (int o = 0; o < 58; o++) {
            if (rising && lightPoints[18][o] == 1) {
                lightPoints[18][o] = 0.8f;
                lightPoints[18][o + 1] = 0.79f;
    ...
    public void draw() {
        ...
        for (int y = 0; y < 32; y++) {
            for (int x = 0; x < 58; x++) {
                ...
                GL11.glVertex2f(x * scale + scale, y * scale);
                ...
                GL11.glVertex2f(x * scale + scale, y * scale + scale);
                ...
                GL11.glVertex2f(x * scale, y * scale + scale);
